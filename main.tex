...
\input{Notation/unPeuDHistoire.tex}

%%%%% SECTION "OUTILS CREATION MUSICALE" %%%%%	
\section{Outils Informatiques pour la création musicale}
\label{sec:outilsInfosProdMus}
\input{OutilsInformatiques/outilsInfosProdMus.tex}	
...
\input{OutilsInformatiques/outilsNotationSymbolique.tex}
...
\input{OutilsInformatiques/outilsNotationElectroMixteMulti.tex}
	
%	\section{Outils pour une notation morphologique de la Musique}
%	\label{sec:outilsNotationMorphologique}
%	\input{OutilsInformatiques/outilsNotationMorphologique.tex}
